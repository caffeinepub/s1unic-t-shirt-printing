...
export class Backend implements backendInterface {
    ...
    async getAllCustomOrders(): Promise<Array<CustomOrderInquiry>> {
        if (this.processError) {
            try {
    ...
    async submitCustomOrder(arg0: string, arg1: string, arg2: string, arg3: string, arg4: bigint, arg5: string): Promise<void> {
        if (this.processError) {
            try {
